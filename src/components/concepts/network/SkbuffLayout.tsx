...
const skbRows: SkbRow[] = [
    {
        ...
        pointer: 'head',
        pointerColor: 'text-orange-500 dark:text-orange-400',
    },
    {
        label: 'Ethernet header (14B)',
        sublabel: 'mac_header',
        size: '14 B',
        color: 'bg-violet-100 dark:bg-violet-900/60',
    ...
    return (
        <div className="flex gap-6 items-start">
            ...
            <div className="flex-1">
                <div className="text-xs text-gray-600 dark:text-gray-400 mb-2 font-mono">sk_buff 메모리 레이아웃</div>
                <div className="flex flex-col border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden text-xs font-mono">
                    {skbRows.map((row, i) => (
                        <div
                            key={i}
            ...
            <div className="w-36 flex flex-col text-xs font-mono">
                <div className="text-gray-600 dark:text-gray-400 mb-2">포인터</div>
                    ...
                    {skbRows
                        ...
                        .map((r, i) => (
                            <div key={i} className="flex items-center gap-2">
                                ...
                                <span className="text-gray-600 dark:text-gray-400 text-[10px]">{r.sublabel}</span>
                            </div>
                        ))}
                </div>
                <div className="mt-4 rounded-lg border border-blue-200 dark:border-blue-800/40 bg-blue-50 dark:bg-blue-950/30 p-2 text-[10px] text-blue-700 dark:text-blue-300">
