...
export function renderRingDiagram(
    ...
    const radii = [maxR, maxR * 0.74, maxR * 0.5, maxR * 0.3, maxR * 0.14]
    ...
    rings.forEach((ring, i) => {
        ...
        svg.append('circle')
            ...
            .on('mouseenter', function () {
                d3.select(this).attr('fill', ring.color + '3a')
            })
            .on('mouseleave', function () {
                d3.select(this).attr('fill', ring.color + (ring.used ? '1e' : '0d'))
            })
    ...
    svg.append('circle')
        ...
        .on('mouseenter', function () {
            d3.select(this).attr('fill', ringData[1].color + '55')
        })
        .on('mouseleave', function () {
            d3.select(this).attr('fill', ringData[1].color + '30')
        })
