    ...
    return (
        <div className="flex flex-col gap-3 p-2">
            <div className="flex items-stretch gap-2">
                {/* Process A */}
                <div
                    className={`flex-1 rounded-lg border-2 p-3 min-h-[160px] transition-all duration-300 ${getBlockClasses(aColor)}`}
                >
                    ...
                    <div className="text-xs text-gray-500 dark:text-gray-400 space-y-1">
                        <div>
                            <span className="font-mono">PID:</span> 1234
                        </div>
                        <div>
                            <span className="font-mono">vruntime:</span> {processAVruntime[step]}
                        </div>
                        <div>
                            <span className="font-mono">nice:</span> 0
                        </div>
                    </div>
                    {step === 1 && (
                ...
                {/* CPU */}
                <div
                    className={`flex-1 rounded-lg border-2 p-3 min-h-[160px] transition-all duration-300 ${
                        cpuGlow
                ...
                >
                    ...
                    <div className="text-xs font-mono space-y-1">
                        <div>
                            <span className="text-gray-500 dark:text-gray-400">PC: </span>
                            <span className="text-green-600 dark:text-green-400">{reg.pc}</span>
                        </div>
                        <div>
                            <span className="text-gray-500 dark:text-gray-400">SP: </span>
                            <span className="text-green-600 dark:text-green-400">{reg.sp}</span>
                        </div>
                        <div>
                            <span className="text-gray-500 dark:text-gray-400">RAX:</span>
                            <span className="text-yellow-600 dark:text-yellow-400"> {reg.rax}</span>
                        </div>
                        <div>
                            <span className="text-gray-500 dark:text-gray-400">RBX:</span>
                            <span className="text-yellow-600 dark:text-yellow-400"> {reg.rbx}</span>
                        </div>
                    </div>
                    {reg.note && (
                ...
                {/* Process B */}
                <div
                    className={`flex-1 rounded-lg border-2 p-3 min-h-[160px] transition-all duration-300 ${getBlockClasses(bColor)}`}
                >
                    ...
                    <div className="text-xs text-gray-500 dark:text-gray-400 space-y-1">
                        <div>
                            <span className="font-mono">PID:</span> 5678
                        </div>
                        <div>
                            <span className="font-mono">vruntime:</span> {processBVruntime[step]}
                        </div>
                        <div>
                            <span className="font-mono">nice:</span> 0
                        </div>
