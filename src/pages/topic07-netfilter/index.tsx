    ...
    return (
        <div className="max-w-4xl mx-auto px-6 py-10 space-y-14">
            ...
            <Section id="s774" title="7.4  iptables와 nftables">
                ...
                <CodeBlock code={iptablesVsNftablesCode} language="bash" filename="iptables vs nftables" />

                <h3 className="text-base font-semibold text-gray-800 dark:text-gray-200 mb-3 mt-6">
                    iptables 핵심 문법
                </h3>
                <CodeBlock code={iptablesMainSyntaxCode} language="bash" filename="# iptables 주요 규칙 예시" />
                <CodeBlock code={nftablesSyntaxCode} language="bash" filename="# nftables 동일 규칙" />
            </Section>
            ...
            <Section id="s775" title="7.5  conntrack (연결 추적)">
                ...
                <CodeBlock code={conntrackCode} language="bash" filename="conntrack CLI" />
                ...
                <CodeBlock code={conntrackTuningCode} language="bash" filename="# conntrack 튜닝" />
            ...
            <Section id="s776" title="7.6  TPROXY와 정책 기반 라우팅">
                ...
                <CodeBlock code={tproxyCode} language="bash" filename="TPROXY 설정" />
            </Section>
            ...
            <Section id="s778" title="7.8  ipset — 대규모 IP 집합 매칭">
                ...
                <CodeBlock code={ipsetCode} language="bash" filename="# ipset 사용법" />
                <TableWrapper>
                    <thead>
                        <tr>
                            <Th>타입</Th>
            ...
            <Section id="s779" title="7.9  Conntrack Helpers — 복잡한 프로토콜 추적">
                ...
                <CodeBlock code={conntrackHelperCode} language="bash" filename="# conntrack helper 활용" />
            </Section>
