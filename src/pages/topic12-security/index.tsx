    ...
    return (
        <div className="max-w-4xl mx-auto px-6 py-10 space-y-14">
            ...
            <Section id="s122" title="12.2  Linux Capabilities">
                ...
                <CodeBlock code={snippets.capabilitiesCode} language="bash" filename="# Capabilities 실전" />
            </Section>
            ...
            <Section id="s123" title="12.3  LSM 프레임워크">
                ...
                <CodeBlock code={snippets.lsmHooksCode} language="c" filename="include/linux/lsm_hooks.h 개념" />
            ...
            <Section id="s124" title="12.4  AppArmor — 경로 기반 MAC">
                ...
                <CodeBlock
                    code={snippets.apparmorProfileCode}
                    language="bash"
                    filename="/etc/apparmor.d/usr.sbin.nginx — 프로파일 예시"
                />
                <CodeBlock code={snippets.apparmorMgmtCode} language="bash" filename="# AppArmor 관리" />
            </Section>
            ...
            <Section id="s125" title="12.5  SELinux — 레이블 기반 MAC">
                ...
                <CodeBlock code={snippets.selinuxCode} language="bash" filename="# SELinux 실전" />
            ...
            <Section id="s126" title="12.6  Namespace — 컨테이너 격리의 기반">
                ...
                <CodeBlock code={snippets.namespaceOverviewCode} language="bash" filename="# Namespace 확인 및 unshare" />
            ...
            <Section id="s127" title="12.7  PID Namespace — 컨테이너 프로세스 격리">
                ...
                {/* 코드 블록 */}
                <CodeBlock code={snippets.pidNsBashCode} language="bash" filename="# PID Namespace 실전" />
