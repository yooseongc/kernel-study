...
import { VirtualAddressViz, MultiProcessVAViz, VABitBreakdown } from '../../components/concepts/memory/VirtualAddressViz'
                        ...
                        unsigned int stride_shift, bool freed_tables)
{
    ...
    on_each_cpu_mask(mm_cpumask(mm), flush_tlb_func, &info, true);
          ...
          커널 코드에서 메모리를 동적 할당할 때 두 가지 주요 API가 있습니다. 물리적 연속성 요구 여부가 선택 기준입니다.
                ...
                <CodeBlock code={snippets.kmallocCode} language="c" filename="include/linux/slab.h + include/linux/vmalloc.h" />
